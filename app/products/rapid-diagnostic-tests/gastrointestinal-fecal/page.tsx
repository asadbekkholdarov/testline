      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
            {language === 'uz' ? 'Oshqozon-ichak va najas testlari' :
             language === 'ru' ? 'Желудочно-кишечные и фекальные тесты' :
             'Gastrointestinal & Fecal Tests'}
          </h1>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            {language === 'uz' ? 'Hazm tizimi kasalliklarini aniqlash uchun professional testlar' :
             language === 'ru' ? 'Профессиональные тесты для выявления заболеваний пищеварительной системы' :
             'Professional tests for detecting digestive system diseases'}
          </p>
        </div>
