  ...
  const products = [
    {
      ...
      description: {
        uz: 'Prostata spetsifik antigen - prostata saratoni skriningi',
        ru: 'Простат-специфический антиген - скрининг рака простаты',
        en: 'Prostate Specific Antigen - prostate cancer screening'
      },
    ...
    },
    {
      ...
      description: {
        uz: 'Karsinoembrional antigen - saraton markeri',
        ru: 'Карциноэмбриональный антиген - онкомаркер',
        en: 'Carcinoembryonic Antigen - cancer marker'
      },
    ...
    },
    {
      ...
      description: {
        uz: 'Alfa-fetoprotein - jigar saratoni markeri',
        ru: 'Альфа-фетопротеин - маркер рака печени',
        en: 'Alpha-fetoprotein - liver cancer marker'
      },
        ...
        <div className="mt-16 text-center">
          <div className="bg-gray-50 rounded-lg p-8">
            ...
            <p className="text-gray-600">
              {language === 'uz' ? 'Onkologiya bo\'yicha yangi testlar ustida ishlamoqdamiz' :
               language === 'ru' ? 'Мы работаем над новыми онкологическими тестами' :
               'We are working on new oncology tests'}
            </p>
          </div>
        </div>
      </div>
