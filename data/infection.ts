...
export const infectiousTests: InfectiousTest[] = [
  ...
  ,
  {
    ...
    description: {
      uz: "TESTLINE H. pylori Ab Tezkor Test Chizig'i - bu to'liq qon, serum yoki plazmada Helicobacter pylori ga qarshi antikorlarni sifatli aniqlash uchun tezkor xromatografik immunoanaliz. Ushbu test H. pylori infeksiyasini tashxislashda yordam berish uchun professional foydalanish uchun mo'ljallangan.",
    ...
    specifications: {
      ...
      specimen: "Whole Blood / Serum / Plasma",
      readingTime: "15 minutes",
      packSizes: "50 T / Box (Cat. No.: TL-HPYLORI-S50), 80 T / Box (Cat. No.: TL-HPYLORI-S80), 100 T / Box (Cat. No.: TL-HPYLORI-S100)",
      storageTemperature: "2–30 °C",
      shelfLife: "2 years",
      sensitivity: "—",
      specificity: "—",
  ...
  },
  {
    ...
    specifications: {
      ...
      readingTime: "15–20 minutes",
      packSizes: "20 T / Box (Cat. No.: TL-HBV5IN1-C20)",
      storageTemperature: "2–30 °C",
      shelfLife: "2 years",
      sensitivity: "—",
      specificity: "—",
  ...
  },
  {
    ...
    description: {
      uz: "TESTLINE HBsAb Tezkor Test Kassettasi - bu to'liq qon, serum yoki plazmada Gepatit B yuzaki antigeniga (HBsAb) qarshi antikorlarni sifatli aniqlash uchun tezkor xromatografik immunoanaliz. Ushbu test Gepatit B virusiga (HBV) qarshi immunitetni aniqlashda yordam berish uchun professional foydalanish uchun mo'ljallangan, xoh emlash yoki o'tmishdagi infeksiyadan tuzalish natijasida bo'lsin.",
  ...
  },
  {
    ...
    description: {
      uz: "TESTLINE Inson Brucella IgM/IgG Tezkor Test Kassettasi - bu to'liq qon, serum yoki plazmada Brucella turlariga qarshi IgM va IgG antikorlarini sifatli aniqlash va farqlash uchun tezkor xromatografik immunoanaliz. Ushbu test brucellozni tashxislashda yordam berish uchun professional foydalanish uchun mo'ljallangan.",
